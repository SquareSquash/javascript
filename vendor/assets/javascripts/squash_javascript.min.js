...
!1;if(this.shouldIgnoreError(b)||!b.stack)return!1;a={};a.api_key=this.options.APIKey;a.environment=this.options.environment;a.client="javascript";a.revision=this.options.revision;a.class_name=null!=(h=b.type)?h:b.name;!b.name&&(d=b.message.match(/^(Uncaught )?(\w+): (.+)/))?(a.class_name=d[2],a.message=d[3]):a.message=b.message;a.message&&(a.message=a.message.substring(0,1E3));null==a.class_name&&(a.class_name="Error");a.backtraces=l(b.stack);a.capture_method=b.mode;a.occurred_at=f(new Date);a.schema=
window.location.protocol.replace(/:$/,"");a.host=window.location.hostname;0<window.location.port.length&&(a.port=window.location.port);a.path=window.location.pathname.substring(0,500);a.query=window.location.search.substring(0,255);""!==window.location.hash&&(a.fragment=window.location.hash.substring(0,255));a.user_agent=navigator.userAgent;a.screen_width=screen.width;a.screen_height=screen.height;a.window_width=window.innerWidth;a.window_height=window.innerHeight;a.color_depth=screen.colorDepth;
if(c)for(x in n=c._squash_user_data,n)q.call(n,x)&&(G=n[x],a[x]=G);e=JSON.stringify(a);this.HTTPTransmit(this.options.APIHost+this.options.notifyPath,[["Content-Type","application/json"]],e);return!0}catch(g){return console.error("Error while trying to notify Squash:",g.stack),console.error("-- original error:",b)}};d.prototype.addUserData=function(b,c){try{return c()}catch(e){throw null==e._squash_user_data&&(e._squash_user_data={}),A(e._squash_user_data,b),e;}};d.prototype.addingUserData=function(b,
c){return function(){var e;e=1<=arguments.length?g.call(arguments,0):[];return SquashJavascript.instance().addUserData(b,function(){return c.apply(null,e)})}};d.prototype.ignoreExceptions=function(){var b,c;c=2<=arguments.length?g.call(arguments,0,b=arguments.length-1):(b=0,[]);b=arguments[b++];try{return b()}catch(e){throw e._squash_ignored_exceptions=(e._squash_ignored_exceptions||[]).concat(c),e;}};d.prototype.ignoringExceptions=function(){var b,c,e;c=2<=arguments.length?g.call(arguments,0,e=arguments.length-
1):(e=0,[]);b=arguments[e++];return function(){var a,e;a=1<=arguments.length?g.call(arguments,0):[];return(e=SquashJavascript.instance()).ignoreExceptions.apply(e,g.call(c).concat([function(){return b.apply(null,a)}]))}};d.prototype.HTTPTransmit=function(b,c,e){var a,d,f;a=new XMLHttpRequest;a.open("POST",b,!0);a.timeout=this.options.transmitTimeout;d=0;for(f=c.length;d<f;d++)b=c[d],a.setRequestHeader(b[0],b[1]);a.send(e);return a};d.prototype.shouldIgnoreError=function(b){var c;c=this.options.ignoredExceptionClasses.concat(b._squash_ignored_exceptions||
[]);return s(c,function(c){return b.name===c})?!0:s(this.options.ignoredExceptionMessages,function(c,a){return b.name===c?s(a,function(a){return b.message.match(a)}):!1})};l=function(b){var c,e,a,d,f;c=[];d=0;for(f=b.length;d<f;d++)a=b[d],(e=a.context)&&s(e,function(b){return b&&200<b.length})&&(e=null),c.push({url:a.url||"unknown",line:a.line||1,column:a.column,symbol:a.func,context:e,type:"minified"});0===c.length&&c.push({url:"fake",line:1,symbol:"",type:"minified"});return[{name:"Active Thread",
faulted:!0,backtrace:c}]};f=function(b){var c;c=function(b){return 10>b?"0"+b:b};return""+b.getUTCFullYear()+"-"+c(b.getUTCMonth()+1)+"-"+c(b.getUTCDate())+"T"+c(b.getUTCHours())+":"+c(b.getUTCMinutes())+":"+c(b.getUTCSeconds())+"Z"};s=function(b,c){var e,a,d;if(b instanceof Array){a=0;for(d=b.length;a<d;a++)if(e=b[a],c(e))return!0}else for(e in b)if(q.call(b,e)&&(a=b[e],c(e,a)))return!0;return!1};A=function(b,c){var e,a,d;d=[];for(e in c)q.call(c,e)&&(a=c[e],d.push(b[e]=a));return d};return d}()}).call(this);var TraceKit={};
TraceKit.report=function(){function m(d,f){var b=null,c;for(c in g)if(g.hasOwnProperty(c))try{g[c](d,f)}catch(e){b=e}if(b)throw b;}function q(l){if(f){if(d===l)return;var g=f;d=f=null;m(g,l)}var b=TraceKit.computeStackTrace(l);f=b;d=l;window.setTimeout(function(){d===l&&(d=f=null,m(b,l))},b.incomplete?2E3:0);throw l;}var g=[],d=null,f=null,s=window.onerror;window.onerror=function(l,g,b){var c=null,e=null;f?(TraceKit.computeStackTrace.augmentStackTraceWithInitialElement(f,g,b,l),c=f,e=d,d=f=null):
(c={url:g,line:b},c.func=TraceKit.computeStackTrace.guessFunctionName(c.url,c.line),c.context=TraceKit.computeStackTrace.gatherContext(c.url,c.line),c={mode:"onerror",message:l,stack:[c]});m(c,e);return s?s.apply(this,arguments):!1};q.subscribe=function(d){g.push(d)};q.unsubscribe=function(d){for(var f=g.length-1;0<=f;--f)g[f]===d&&g.splice(f,1)};return q}();
TraceKit.computeStackTrace=function(){function m(b){try{void 0===XMLHttpRequest&&(XMLHttpRequest=function(){try{return new ActiveXObject("Msxml2.XMLHTTP.6.0")}catch(b){}try{return new ActiveXObject("Msxml2.XMLHTTP.3.0")}catch(a){}try{return new ActiveXObject("Msxml2.XMLHTTP")}catch(c){}try{return new ActiveXObject("Microsoft.XMLHTTP")}catch(G){}throw Error("No XHR.");});var a=new XMLHttpRequest;a.open("GET",b,!1);a.send("");return a.responseText}catch(c){return""}}function q(b){if(!C.hasOwnProperty(b)){var a;
...
k=[],h,n=0,C=m.length;n<C;n+=2)if(h=f.exec(m[n])){var v={line:+h[1],column:+h[2],func:h[3]||h[4],args:h[5]?h[5].split(","):[],url:h[6]};!v.func&&v.line&&(v.func=g(v.url,v.line));if(v.line)try{v.context=d(v.url,v.line)}catch(X){}v.context||(v.context=[m[n+1]]);k.push(v)}c=k.length?{mode:"stacktrace",name:a.name,message:a.message,stack:k}:null;if(c)return c}catch(P){if(x)throw P;}try{if(a.stack){var f=/^\s*at (?:new )?(.+) (?:\[as \S+\] )?\(((?:file|https?):.*?):(\d+)(?::(\d+))?\)\s*$/i,m=/^\s*(\S*)(?:\((.*?)\))?@((?:file|https?).*?):(\d+)(?::(\d+))?\s*$/i,
...
message:a.message,stack:k}:null}else c=null;if(c)return c}catch(Q){if(x)throw Q;}try{var y=a.message.split("\n");if(4>y.length)c=null;else{D=/^\s*Line (\d+) of linked script ((?:file|https?)\S+)(?:: in function (\S+))?\s*$/i;r=/^\s*Line (\d+) of inline#(\d+) script in ((?:file|https?)\S+)(?:: in function (\S+))?\s*$/i;t=/^\s*Line (\d+) of function script\s*$/i;var B=[],p=document.getElementsByTagName("script"),F=[],w,u,L,z;for(u in p)p.hasOwnProperty(u)&&!p[u].src&&F.push(p[u]);u=2;for(L=y.length;u<
L;u+=2){p=null;if(w=D.exec(y[u]))p={url:w[2],func:w[3],line:+w[1]};else if(w=r.exec(y[u])){var p={url:w[3],func:w[4]},R=+w[1],M=F[w[2]-1];if(M&&(z=q(p.url))){z=z.join("\n");var N=z.indexOf(M.innerText);0<=N&&(p.line=R+z.substring(0,N).split("\n").length)}}else if(w=t.exec(y[u])){var O=window.location.href.replace(/#.*$/,""),S=w[1],T=RegExp(s(y[u+1]));z=l(T,[O]);p={url:O,line:z?z.line:S,func:""}}if(p){p.func||(p.func=g(p.url,p.line));var E=d(p.url,p.line),U=E?E[Math.floor(E.length/2)]:null;E&&U.replace(/^\s*/,
