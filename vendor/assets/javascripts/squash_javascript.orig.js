...
(function() {
  ...
  _SquashJavascript = (function() {
    ...
    _SquashJavascript.prototype.report = function(info, error) {
      var body, fields, internal_error, k, key, matches, v, value, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8;
      ...
      try {
        ...
        _ref5 = this.options.globalUserData;
        for (key in _ref5) {
          if (!__hasProp.call(_ref5, key)) continue;
          value = _ref5[key];
          fields[key] = value;
        }
        fields.class_name = (_ref6 = info.type) != null ? _ref6 : info.name;
        ...
        if ((_ref7 = fields.class_name) == null) {
        ...
        if (error) {
          _ref8 = error._squash_user_data;
          for (k in _ref8) {
            if (!__hasProp.call(_ref8, k)) continue;
            v = _ref8[k];
            fields[k] = v;
          }
        }
